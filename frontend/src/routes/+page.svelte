...
<ContentLayout variant="heading" title="Time Tracker" description="Rapid Entry">
	...
	<div class="flex pt-4 pb-0 gap-0 w-full">
		{#each days as { date, day, hours }, i}
			<button on:click={() => selectDay(i)} class="flex-1">
				<div
					class="flex flex-col border
          border-black
          cursor-pointer {i === selected ? 'bg-green-300 border-b-green-300' : ''}"
				>
	...
	<div class="flex w-full bg-green-300 border border-t-0 border-black min-h-[400px]">
